...
public class UserController {
     ...
     *
     * @param signupUserRequest user details for registration in form of SignupUserRequest model
     *
     * @return JSON response with user uuid and message
     *
     * @throws SignUpRestrictedException if user details has some issues
     */
    ...
    public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest) throws SignUpRestrictedException {
        ...
        //Return a newly created userEntity in response
    ...
    public ResponseEntity<SigninResponse> signin(@RequestHeader("authorization") final String authorization) throws AuthenticationFailedException {
        ...
        //User authorization code-decode
